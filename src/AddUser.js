...
const addUserVdationSchema  =  yup.object({
...
function AddUser() {
  ...
  validationSchema:addUserVdationSchema,
  onSubmit: (values) => {
            ...
            <div className="row g-0">
              ...
              <div className="col-lg-6 bg-indigo text-white">
                <div className="p-5">
                  ...
                  <button type="submit" className="btn btn-light btn-lg" data-mdb-ripple-color="dark" >Add User</button>
                  <button type="button" className="btn btn-primary btn-lg m-2" data-mdb-ripple-color="dark"  onClick={()=>history.push(`/`)}>Cancel</button>
